  ...
  const applyLayout = useCallback(
    (animate: boolean) => {
      ...
      panels.forEach((panel, i) => {
        ...
        tl.to(panel, { flexGrow: isActive ? grow : 1, ...(prefersReduced ? {} : rotProp), duration: dur, ease }, 0);
        ...
        if (media) {
          ...
          tl.to(
            media,
            {
              xPercent: -50,
              yPercent: -50,
              x: vertical ? 0 : isActive ? 0 : (prefersReduced ? 0 : shift),
              y: vertical ? (isActive ? 0 : (prefersReduced ? 0 : shift)) : 0,
              '--ag-gray': gray,
